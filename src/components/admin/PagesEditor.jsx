...
export default function PagesEditor() {
    ...
    return (
        <div className="flex gap-10 -m-10 min-h-screen">
            ...
            <div className="w-72 bg-[#f9fafb] border-r border-gray-100 flex flex-col">
                <div className="p-6">
            ...
            <div className="flex-1 bg-white overflow-y-auto">
                {selectedPage ? (
                    <div className="p-10 max-w-4xl mx-auto space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
                        {/* Editor Header */}
