...
function AssetCard({ asset, brand, viewMode, isAdmin, onRemove, onUpdate, dragHandleProps }) {
                ...
                <div className={
                    viewMode === 'grid'
                        ? filteredAssets.length === 4
                            ? 'grid grid-cols-1 md:grid-cols-2 gap-4'  // 2x2 grid for exactly 4 items
                            : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'  // 3 per row otherwise
                        : 'space-y-3'
                }>
