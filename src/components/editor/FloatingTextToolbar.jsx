...
export default function FloatingTextToolbar() {
    ...
    // Create array of format states to check adjacency
    const formatOrder = ['bold', 'italic', 'underline', 'strikeThrough', 'mono']
    const activeStates = formatOrder.map(f => activeFormats[f])
