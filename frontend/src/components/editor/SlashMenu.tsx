...
interface SlashMenuProps {
    ...
    onSelect: (item: MenuItem | BlockData[]) => void
    onClose: () => void
}
...
export default function SlashMenu({ position, onSelect, onClose }: SlashMenuProps) {
    ...
    const [clipboardBlocks, setClipboardBlocks] = useState<BlockData[] | null>(null)
    ...
    const checkClipboard = async () => {
        try {
            ...
            const isValidBlock = (b: unknown): b is BlockData =>
                b !== null && typeof b === 'object' && 'id' in b && 'type' in b &&
                typeof (b as BlockData).id === 'string' && typeof (b as BlockData).type === 'string'
    ...
    const menuItems: MenuGroup[] = clipboardBlocks ? [
        {
            label: 'Clipboard',
            items: [{
                id: 'paste',
