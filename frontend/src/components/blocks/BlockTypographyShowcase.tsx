...
interface BlockTypographyShowcaseData {
    fontFamily: string
    specimens: Specimen[]
}

interface BlockTypographyShowcaseProps {
    data: BlockTypographyShowcaseData
}

export default function BlockTypographyShowcase({ data }: BlockTypographyShowcaseProps) {
