 ...
 *
 * Run with: node --env-file=.env.local scripts/migrate_direct_api.js
 * Requires SUPABASE_URL / SUPABASE_SERVICE_ROLE_KEY (source) and
 * NOBORA_SUPABASE_URL / NOBORA_SUPABASE_SERVICE_ROLE_KEY (destination) in .env.local
 */

import { createClient } from '@supabase/supabase-js'

const oldClient = createClient(process.env.SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY)
const newClient = createClient(process.env.NOBORA_SUPABASE_URL, process.env.NOBORA_SUPABASE_SERVICE_ROLE_KEY)
