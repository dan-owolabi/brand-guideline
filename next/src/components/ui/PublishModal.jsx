...
export function PublishModal({ isOpen, onClose, onConfirm, initialSlug, brandName, isPublishing }) {
    ...
    // This component never unmounts (parent always renders it), so reset state
    // whenever isOpen flips from closed to open. Adjusting state during render
    // (rather than in an effect) avoids an extra render with stale values.
